...
(load-file "c:/users/hessellundm/emacs-config/bootstrap.el")
#+END_SRC
...
(use-package dired-subtree
  ...
  (bind-keys :map dired-mode-map
             ...
             ("<tab>" dired-subtree-toogle dired-mode-map)))
#+END_SRC
...
(defun remove-newlines-in-region-no-blank ()
  "Removes all newlines in the region."
  (interactive)
  (save-restriction
    (narrow-to-region (point) (mark))
...
(global-set-key [f8] 'remove-newlines-in-region-no-blank)
